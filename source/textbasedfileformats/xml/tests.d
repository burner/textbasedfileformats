module textbasefileformats.xml.tests;

import textbasedfileformats.xml;
...
auto indexes =
[
    "xmltests/sun/sun-valid.xml",
    "xmltests/sun/sun-error.xml",
    "xmltests/sun/sun-invalid.xml",
    "xmltests/sun/sun-not-wf.xml",
    "xmltests/xmltest/xmltest.xml",
    "xmltests/oasis/oasis.xml",
    "xmltests/ibm/ibm_oasis_invalid.xml",
    "xmltests/ibm/ibm_oasis_not-wf.xml",
    "xmltests/ibm/ibm_oasis_valid.xml",
    "xmltests/ibm/xml-1.1/ibm_invalid.xml",
    "xmltests/ibm/xml-1.1/ibm_not-wf.xml",
    "xmltests/ibm/xml-1.1/ibm_valid.xml",
    "xmltests/eduni/errata-2e/errata2e.xml",
    "xmltests/eduni/xml-1.1/xml11.xml",
    "xmltests/eduni/namespaces/1.0/rmt-ns10.xml",
    "xmltests/eduni/namespaces/1.1/rmt-ns11.xml",
    "xmltests/eduni/errata-3e/errata3e.xml",
    "xmltests/eduni/namespaces/errata-1e/errata1e.xml",
    "xmltests/eduni/errata-4e/errata4e.xml",
    "xmltests/eduni/misc/ht-bh.xml"
];
...
bool parseFile(string filename, ref bool lint)
{
    ...
    /+if (lint)
    {
        ...
        import textbasedfileformats.xml.writer;
