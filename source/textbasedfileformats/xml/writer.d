...
void writeDOM(WriterType)(auto ref WriterType writer, dom.Node node)
{
    ...
    import std.conv : to;
    import textbasedfileformats.xml.faststrings;
...
@safe unittest
{
    import textbasedfileformats.xml.domimpl;
       ...
       (isCursor!CursorType && is(WriterType.StringType == CursorType.StringType))))
{
    ...
    static if (is(CursorType == void))
    {
        struct Cursor
        {
            import textbasedfileformats.xml.cursor: Attribute;
...
unittest
{
    import textbasedfileformats.xml.validation;
    import std.typecons : refCounted;
