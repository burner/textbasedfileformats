...
/++
    ...
    Source:    $(LINK_TO_SRC textbasedfileformats.xml/_writer.d)

    See_Also: $(LINK2 http://www.w3.org/TR/REC-xml/, Official Specification for XML 1.0)
  +/
module textbasedfileformats.xml.writer;
...
/++
    ...
    See_Also: $(LREF writeXMLDecl)$(BR)
              $(REF encodeAttr, textbasedfileformats.xml, util)$(BR)
              $(REF encodeText, textbasedfileformats.xml, util)$(BR)
              $(REF StdEntityRef, textbasedfileformats.xml, util)$(BR)
              $(REF toCharRef, textbasedfileformats.xml, util)$(BR)
  +/
struct XMLWriter(OR)
...
public:
    ...
    {
        import textbasedfileformats.xml.internal : TestAttrOR;
    ...
    /++
        ...
        Throws: $(LREF XMLWritingException) if the given _name is not a valid
                ...
                to the current start tag. $(REF encodeAttr, textbasedfileformats.xml, util) can be
                used to encode any characters that are not legal in their
                literal form in an attribute _value but are legal as entity
                references.

        See_Also: $(REF encodeAttr, textbasedfileformats.xml, util)$(BR)
                  $(REF StdEntityRef, textbasedfileformats.xml, util)$(BR)
                  $(REF toCharRef, textbasedfileformats.xml, util)$(BR)
    ...
    static if(compileInTests) unittest
    {
        import std.array : appender;
        import std.exception : assertThrown;
        import textbasedfileformats.xml.util : encodeAttr;
        ...
        // Use textbasedfileformats.xml.util.encodeAttr to encode characters that aren't
    ...
    /++
        ...
        Throws: $(LREF XMLWritingException) if any characters or sequence of
                ...
                of an XML document. $(REF encodeText, textbasedfileformats.xml, util) can be used
    ...
    static if(compileInTests) unittest
    {
        import std.array : appender;
        import std.exception : assertThrown;
        import textbasedfileformats.xml.util : encodeText;
        ...
        }
        {
            ...
            // Use textbasedfileformats.xml.util.encodeText to encode characters that aren't
...
/++
    ...
    Throws: $(LREF XMLWritingException) if the given _name is an invalid XML
            ...
            document. $(REF encodeText, textbasedfileformats.xml, util) can be used to encode any
