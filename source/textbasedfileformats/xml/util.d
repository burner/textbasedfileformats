...
/++
    ...
    $(TABLE
        ...
        $(TR $(TD $(LREF encodeText))
             $(TD Encodes characters which cannot appear in
                  $(REF_ALTTEXT EntityType.text, EntityType.text, textbasedfileformats.xml, parser)
    ...
    Source:    $(LINK_TO_SRC textbasedfileformats.xml/_util.d)

    See_Also: $(LINK2 http://www.w3.org/TR/REC-xml/, Official Specification for XML 1.0)
  +/
module textbasedfileformats.xml.util;
...
/++
    ...
    properties of an $(REF_ALTTEXT Entity, EntityRange.Entity, textbasedfileformats.xml, parser).
    ...
    them properly would require handling the DTD section, which textbasedfileformats.xml does not
    ...
    decodeXML doesn't come from textbasedfileformats.xml's parser, it can't have any entity
    ...
    See_Also: $(LINK http://www.w3.org/TR/REC-xml/#dt-chardata)$(BR)
              ...
              $(REF EntityRange.Entity.attributes, textbasedfileformats.xml, parser)$(BR)
              $(REF EntityRange.Entity.text, textbasedfileformats.xml, parser)$(BR)
              $(LREF encodeAttr)$(BR)
              $(LREF encodeText)
  +/
...
/++
    ...
    $(REF_ALTTEXT Entity.text, EntityRange.Entity.text, textbasedfileformats.xml, parser)).
    ...
    See_Also: $(REF EntityRange.Entity.text, textbasedfileformats.xml, parser)
  +/
...
/++
    ...
    be put in an $(REF EntityType._text, textbasedfileformats.xml, parser) in their literal form.

    encodeText is intended primarily to be used with
    $(REF XMLWriter.writeText, textbasedfileformats.xml, writer) to ensure that characters which
    ...
    See_Also: $(REF XMLWriter.writeText, textbasedfileformats.xml, writer)$(BR)
              $(LREF encodeAttr)$(BR)
              $(LREF decodeXML)$(BR)
              $(LREF asDecodedXML)
  +/
...
/++
    ...
    $(REF XMLWriter.writeAttr, textbasedfileformats.xml, writer) to ensure that characters
    ...
    See_Also: $(REF XMLWriter.writeAttr, textbasedfileformats.xml, writer)$(BR)
              $(LREF encodeText)$(BR)
              $(LREF decodeXML)$(BR)
              $(LREF asDecodedXML)
  +/
