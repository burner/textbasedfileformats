...
/++
    ...
    However, $(REF_ALTTEXT decodeXML, decodeXML, textbasedfileformats.xml, util) or
    $(REF_ALTTEXT parseStdEntityRef, parseStdEntityRef, textbasedfileformats.xml, util) from
    $(MREF textbasedfileformats.xml, util) can be used to convert the predefined entity references
    to what the refer to, and $(REF_ALTTEXT decodeXML, decodeXML, textbasedfileformats.xml, util) or
    $(REF_ALTTEXT parseCharRef, parseCharRef, textbasedfileformats.xml, util) from
    $(MREF textbasedfileformats.xml, util) can be used to convert character references to what they
    refer to.
    ...
    Source:    $(LINK_TO_SRC textbasedfileformats.xml/_parser.d)

    See_Also: $(LINK2 http://www.w3.org/TR/REC-xml/, Official Specification for XML 1.0)
  +/
module textbasedfileformats.xml.parser;
...
struct Config
{
    ...
    /++
        ...
        However, textbasedfileformats.xml does not support parsing the DTD beyond what is required
        ...
        $(LREF EntityRange) provides. As such, it is not possible for textbasedfileformats.xml to
        ...
        $(REF decodeXML, textbasedfileformats.xml, util) or $(REF parseStdEntityRef, textbasedfileformats.xml, util).
        ...
        See_Also: $(REF StdEntityRef, textbasedfileformats.xml, util)$(BR)
                  $(REF parseStdEntityRef, textbasedfileformats.xml, util)$(BR)
                  $(REF parseCharRef, textbasedfileformats.xml, util)$(BR)
                  $(REF encodeCharRef, textbasedfileformats.xml, util)$(BR)
                  $(REF decodeXML, textbasedfileformats.xml, util)$(BR)
                  $(REF asDecodedXML, textbasedfileformats.xml, util)
      +/
    ...
    unittest
    {
        ...
        import textbasedfileformats.xml.util : decodeXML;
...
enum EntityType
{
    ...
    /++
        ...
        $(REF_ALTTEXT decodeXML, decodeXML, textbasedfileformats.xml, util) or
        $(REF_ALTTEXT asDecodedXML, asDecodedXML, textbasedfileformats.xml, util). Entity references
        ...
        See_Also: $(LINK http://www.w3.org/TR/REC-xml/#sec-starttags)$(BR)
                  $(REF decodeXML, textbasedfileformats.xml, util)$(BR)
                  $(REF asDecodedXML, textbasedfileformats.xml, util)$(BR)
                  $(REF parseStdEntityRef, textbasedfileformats.xml, util)$(BR)
                  $(REF parseCharRef, textbasedfileformats.xml, util)$(BR)
...
/++
    ...
    $(REF decodeXML, textbasedfileformats.xml, util) must be called on the text to mutate certain
    ...
    $(REF decodeXML, textbasedfileformats.xml, util) can be used to strip them along with
...
public:
    ...
    public:
        ...
        {
            import textbasedfileformats.xml.internal : checkedSave, stripBCU;
            with(EntityType)
            {
                import std.format : format;
        ...
        @property auto attributes()
        {
            ...
            static struct AttributeRange
            {
                ...
                void popFront()
                {
                    import textbasedfileformats.xml.internal : stripBCU;
        ...
        static if(compileInTests) unittest
        {
            ...
            import textbasedfileformats.xml.internal : codeLen, testRangeFuncs;
        ...
        /++
            ...
            See_Also: $(REF decodeXML, textbasedfileformats.xml, util)$(BR)
                      $(REF asDecodedXML, textbasedfileformats.xml, util)$(BR)
...
/++
    ...
    $(REF_ALTTEXT DOMEntity.attributes, DOMEntity.attributes, textbasedfileformats.xml, dom), but
    ...
    See_Also: $(LREF EntityRange.Entity.Attribute)$(BR)
              ...
              $(REF_ALTTEXT DOMEntity.Attribute, DOMEntity.Attribute, textbasedfileformats.xml, dom)$(BR)
              $(REF_ALTTEXT DOMEntity.attributes, DOMEntity.attributes, textbasedfileformats.xml, dom)
  +/
...
{
    import std.typecons : Tuple;
    import textbasedfileformats.xml.dom : parseDOM;
...
unittest
{
    import core.exception : AssertError;
    import std.exception : enforce;
    import textbasedfileformats.xml.internal : equalCU, testRangeFuncs;
...
unittest
{
    import core.exception : AssertError;
    import std.exception : enforce;
    import textbasedfileformats.xml.internal : equalCU;
    import textbasedfileformats.xml.internal : testRangeFuncs;
...
template takeName(delims...)
{
    ...
    auto takeName(Text)(ref Text text)
    {
        ...
        import textbasedfileformats.xml.internal : isNameStartChar, isNameChar;
...
// textbasedfileformats.xml.util.parseCharRef will check that it is fully correct if it is used.
        ...
        if(quote == quoteChar)
        {
            ...
            loop: while(true)
            {
                ...
                switch(text.input.front)
                {
                    ...
                    {
                        {
                            import textbasedfileformats.xml.util : parseCharRef;
                    ...
                    default:
                    {
                        ...
                        import std.format : format;
                        import textbasedfileformats.xml.internal : isXMLChar;
