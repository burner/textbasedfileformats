...
module textbasedfileformats.xml.domimpl;

import textbasedfileformats.xml.interfaces;

import dom = textbasedfileformats.xml.dom;
...
/++
+   An implementation of $(LINK2 ../dom/DOMImplementation, `textbasedfileformats.xml.dom.DOMImplementation`).
+
...
@safe:
    ...
    override
    {
        ...
        +   `textbasedfileformats.xml.dom.DOMImplementation.createDocumentType`).
        +/
        ...
        +   `textbasedfileformats.xml.dom.DOMImplementation.createDocument`).
        +/
        ...
        +   `textbasedfileformats.xml.dom.DOMImplementation.hasFeature`).
        +
    ...
    /++
    +   The implementation of $(LINK2 ../dom/DOMException, `textbasedfileformats.xml.dom.DOMException`)
    ...
    class DOMException: dom.DOMException
    {
        ...
        /// Implementation of $(LINK2 ../dom/DOMException.code, `textbasedfileformats.xml.dom.DOMException.code`).
    ...
    /// Implementation of $(LINK2 ../dom/Node, `textbasedfileformats.xml.dom.Node`)
    abstract class Node : dom.Node
    {
        ...
        override
        {
            /// Implementation of $(LINK2 ../dom/Node.ownerDocument, `textbasedfileformats.xml.dom.Node.ownerDocument`).
            @property Document ownerDocument() { return this._ownerDocument; }

            /// Implementation of $(LINK2 ../dom/Node.parentNode, `textbasedfileformats.xml.dom.Node.parentNode`).
            @property Node parentNode() { return this._parentNode; }
            /++
            +   Implementation of $(LINK2 ../dom/Node.previousSibling,
            +   `textbasedfileformats.xml.dom.Node.previousSibling`).
            +/
            @property Node previousSibling() { return this._previousSibling; }
            /// Implementation of $(LINK2 ../dom/Node.nextSibling, `textbasedfileformats.xml.dom.Node.nextSibling`).
            @property Node nextSibling() { return this._nextSibling; }

            /++
            +   Implementation of $(LINK2 ../dom/Node.isSameNode, `textbasedfileformats.xml.dom.Node.isSameNode`).
            +
            ...
            /// Implementation of $(LINK2 ../dom/Node.isEqualNode, `textbasedfileformats.xml.dom.Node.isEqualNode`).
            ...
            /// Implementation of $(LINK2 ../dom/Node.setUserData, `textbasedfileformats.xml.dom.Node.setUserData`).
            ...
            /// Implementation of $(LINK2 ../dom/Node.getUserData, `textbasedfileformats.xml.dom.Node.getUserData`).
            ...
            /++
            +   Implementation of $(LINK2 ../dom/Node.isSupported, `textbasedfileformats.xml.dom.Node.isSupported`).
            +
            +   Only recognizes features `"Core"`and `"XML"` with versions `"1.0"`,
            +   `"2.0"` or `"3.0"`.
            +/
            ...
            /++
            +   Implementation of $(LINK2 ../dom/Node.getFeature, `textbasedfileformats.xml.dom.Node.getFeature`).
            +
            +   Only recognizes features `"Core"`and `"XML"` with versions `"1.0"`,
            +   `"2.0"` or `"3.0"`. Always returns this.
            +/
            ...
            +   `textbasedfileformats.xml.dom.Node.compareDocumentPosition`).
            +/
    ...
    /// Implementation of $(LINK2 ../dom/DocumentFragment, `textbasedfileformats.xml.dom.DocumentFragment`)
    ...
    /// Implementation of $(LINK2 ../dom/Document, `textbasedfileformats.xml.dom.Document`)
    ...
    /// Implementation of $(LINK2 ../dom/CharacterData, `textbasedfileformats.xml.dom.CharacterData`)
    ...
    /// Implementation of $(LINK2 ../dom/Attr, `textbasedfileformats.xml.dom.Attr`)
    class Attr : NodeWithNamespace, dom.Attr
    {
        // specific to Attr
        override
        {
            /// Implementation of $(LINK2 ../dom/Attr.name, `textbasedfileformats.xml.dom.Attr.name`).
            @property string name() { return _name; }
            /// Implementation of $(LINK2 ../dom/Attr.specified, `textbasedfileformats.xml.dom.Attr.specified`).
            @property bool specified() { return _specified; }
            /// Implementation of $(LINK2 ../dom/Attr.value, `textbasedfileformats.xml.dom.Attr.value`).
            ...
            /// Implementation of $(LINK2 ../dom/Attr.ownerElement, `textbasedfileformats.xml.dom.Attr.ownerElement`).
            @property Element ownerElement() { return this._ownerElement; }
            /// Implementation of $(LINK2 ../dom/Attr.schemaTypeInfo, `textbasedfileformats.xml.dom.Attr.schemaTypeInfo`).
            @property dom.XMLTypeInfo schemaTypeInfo() { return null; }
            /// Implementation of $(LINK2 ../dom/Attr.isId, `textbasedfileformats.xml.dom.Attr.isId`).
    ...
    /// Implementation of $(LINK2 ../dom/Element, `textbasedfileformats.xml.dom.Element`)
    class Element : NodeWithNamespace, dom.Element
    {
        ...
        override
        {
            /// Implementation of $(LINK2 ../dom/Element.tagName, `textbasedfileformats.xml.dom.Element.tagName`).
            @property string tagName() { return _name; }

            /++
            +   Implementation of $(LINK2 ../dom/Element.getAttribute,
            +   `textbasedfileformats.xml.dom.Element.getAttribute`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.setAttribute`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.removeAttribute`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.getAttributeNode`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.setAttributeNode`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.removeAttributeNode`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.getAttributeNS`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.setAttributeNS`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.removeAttributeNS`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.getAttributeNodeNS`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.setAttributeNodeNS`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.hasAttribute`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.hasAttributeNS`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.setIdAttribute`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.setIdAttributeNS`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.getElementsByTagName`).
            +/
            ElementsByTagName getElementsByTagName(string tagname)
            {
                ElementsByTagName res = new ElementsByTagName();
            ...
            +   `textbasedfileformats.xml.dom.Element.getElementsByTagNameNS`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.Element.schemaTypeInfo`).
            +/
            @property dom.XMLTypeInfo schemaTypeInfo() { return null; }
        }
        private
    ...
    /// Implementation of $(LINK2 ../dom/Text, `textbasedfileformats.xml.dom.Text`)
    class Text: CharacterData, dom.Text
    {
        // specific to Text
        override
        {
            /// Implementation of $(LINK2 ../dom/Text.splitText, `textbasedfileformats.xml.dom.Text.splitText`).
            ...
            +   `textbasedfileformats.xml.dom.Text.isElementContentWhitespace`).
            +/
            ...
            /// Implementation of $(LINK2 ../dom/Text.wholeText, `textbasedfileformats.xml.dom.Text.wholeText`).
            ...
            +   `textbasedfileformats.xml.dom.Text.replaceWholeText`).
            +/
    ...
    /// Implementation of $(LINK2 ../dom/Comment, `textbasedfileformats.xml.dom.Comment`)
    ...
    /// Implementation of $(LINK2 ../dom/DocumentType, `textbasedfileformats.xml.dom.DocumentType`)
    ...
    /// Implementation of $(LINK2 ../dom/CDATASection, `textbasedfileformats.xml.dom.CDATASection`)
    ...
    /// Implementation of $(LINK2 ../dom/ProcessingInstruction, `textbasedfileformats.xml.dom.ProcessingInstruction`)
    class ProcessingInstruction : Node, dom.ProcessingInstruction
    {
        ...
        override
        {
            ...
            +   `textbasedfileformats.xml.dom.ProcessingInstruction.target`).
            +/
            @property string target() { return this._target; }
            /++
            +   Implementation of $(LINK2 ../dom/ProcessingInstruction.data,
            +   `textbasedfileformats.xml.dom.ProcessingInstruction.data`).
            +/
            @property string data() { return this._data; }
            /// ditto
            @property void data(string newVal) { this._data = newVal; }
    ...
    ///Implementation of textbasedfileformats.xml.dom.Entity
    ...
    /// Implementation of $(LINK2 ../dom/EntityReference, `textbasedfileformats.xml.dom.EntityReference`)
    ...
    /// Implementation of $(LINK2 ../dom/DOMConfiguration, `textbasedfileformats.xml.dom.DOMConfiguration`)
    class DOMConfiguration : dom.DOMConfiguration
    {
        ...
        override
        {
            ...
            +   `textbasedfileformats.xml.dom.DOMConfiguration.setParameter`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.DOMConfiguration.getParameter`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.DOMConfiguration.canSetParameter`).
            +/
            ...
            +   `textbasedfileformats.xml.dom.DOMConfiguration.parameterNames`).
            +/
...
{
    import dompar = textbasedfileformats.xml.domparser;
...
@safe unittest
{
    import textbasedfileformats.xml.lexers;
    import textbasedfileformats.xml.parser;
    import textbasedfileformats.xml.cursor;
    import std.stdio;
